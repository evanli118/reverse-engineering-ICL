...
config.adam = True # optimizer
config.pre_train_gd = False # whether to use GD++ as the constructed transformer
config.train_gd_whitening = True
config.train_gd_lr = True
config.lr = 0.001
config.dropout_rate = 0.0
config.bs = 512 # batch_size for data during each training step
